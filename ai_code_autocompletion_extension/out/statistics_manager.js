...
class StatisticsManager {
    ...
    loadStatistics() {
        const savedStats = this.context.globalState.get('completionStats');
        if (savedStats) {
            this.stats = {
                ...savedStats,
    ...
    recordCompletion(language, suggestionCount, responseTime, cacheHit) {
        // Update global stats
    ...
    async showStatistics() {
        ...
        const panel = vscode.window.createWebviewPanel('aiCompletionStats', 'AI Completion Statistics', vscode.ViewColumn.One, {
            enableScripts: true,
            retainContextWhenHidden: true
        });
        panel.webview.html = this.generateStatsHTML(stats, acceptanceRate, cacheHitRate, sessionDuration);
    }
    generateStatsHTML(stats, acceptanceRate, cacheHitRate, sessionDuration) {
...
//# sourceMappingURL=statistics_manager.js.map