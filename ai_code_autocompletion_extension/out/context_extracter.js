...
class ContextExtractor {
    ...
    getPreviousLines(document, currentLine) {
    ...
    extractClassContext(document, position) {
        let className = null;
        const methods = [];
        const properties = [];
    ...
    extractClassMembers(document, position, methods, properties) {
    ...
    extractVariables(document, position) {
        const variables = [];
...
//# sourceMappingURL=context_extracter.js.map